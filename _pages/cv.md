...
<section id="appointments">
  ...
  <p>
    <strong>Georgia College & State University</strong> (Milledgeville, GA) <br>
    Lecturer of Finance <span style="float:right;"> August 2026-Present</span><br>
  </p>
</section>
...
<ul>
  <li>
    <a href="https://colin-p-adams.github.io/papers/SchoolCutoffsAndCrime.pdf" target="_blank">&ldquo;The Lifelong Criminal Consequences of Kindergarten Cutoff Dates&rdquo;</a>
    <br>
  ...
  <li>
    &ldquo;Math Curriculum and Labor Markets: Long-Run Evidence from New Math&rdquo;
    <br>
    <span style="display: block; height: 5px;"></span>
  </li>
  <li>
  ...
  <ul>
    <li>
      <a href="https://journals.sagepub.com/doi/pdf/10.1177/05694345241292611" target="_blank">
        &ldquo;NFL QB Development—The Role of Competing QBs, Rookie Playing Time, and Team Quality&rdquo;
      </a>, <em>The American Economist</em>, 2025 with <a href="https://scholar.google.com/citations?user=fIReWHEAAAAJ&hl=en" target="_blank">Brent Evans</a>, 
...
<section>
    ...
    <ul>
        <li>Personal Finance <span style="float:right;">Fall, 2026</span></li>
    </ul>
    <ul>
        <li>Money and Banking <span style="float:right;">Fall, 2026</span></li>
    </ul>
...
<section id="honors">
  ...
  <ul>
    <li>Mercatus Fellowship, George Mason University <span style="float:right;">2026-2027</span></li>
    <li>Charles and Persis Rockwood Fellowship, Florida State University <span style="float:right;">2023-2026</span></li>
    <li>Don Lavoie Fellowship, George Mason University <span style="float:right;">2026</span></li>
    <li>Hayek Fund for Scholars, Institute for Humane Studies <span style="float:right;">2023</span></li>
...
<section id="research-assistantships">
  ...
  <p>
    ...
    <span class="indent">With <a href="https://sites.google.com/site/jbkimecon/" target="_blank">Dr. Jeongbin Kim</a> 
